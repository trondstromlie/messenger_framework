  ...
  const user_process = {processes: [
    {
     ...
     steps: [
         ...
         {name:"ask for email quick reply",func:process_functions.send_quick_reply,msg:"velg her!",quick_reply_obj:[{"title":"email","payload":"email"}]},
         ...
         {name:"confirm email",func:process_functions.send_quick_reply,quick_reply_obj:[{"title":"Ja","payload":"send takk",link:8},{"title":"Nei","payload":"ask for email",link:2}]},
         {name:"listen_for_email",func:process_functions.listen_for_quick_reply,custom_field_name:"email", msg:"Skriv ja eller nei >> " , quick_reply_obj:[{"title":"Ja","payload":"send takk",link:8},{"title":"Nei","payload":"ask for email",link:2}]},
         ...
         {name:"confirm mor",func:process_functions.send_quick_reply,quick_reply_obj:[{"title":"Ja","payload":"send to bio",link:15},{"msg":"Nei","payload":"ask for mother",link:10}]},
         {name:"listen_for_mor",func:process_functions.listen_for_quick_reply,custom_field_name:"mor", msg:"Skriv ja eller nei >> " , quick_reply_obj:[{"title":"Ja","payload":"send to bio",link:15},{"title":"Nei","payload":"ask for mother",link:10}]},
         ...
         {name:"confirm bio",func:process_functions.send_quick_reply,quick_reply_obj:[{"title":"Ja","payload":"send to bio",link:20},{"title":"Nei","payload":"ask for bio",link:15}]},
         {name:"listen_for_bio",func:process_functions.listen_for_quick_reply,custom_field_name:"mor", "":"Skriv ja eller nei >> " , quick_reply_obj:[{"title":"Ja","payload":"send to bio",link:20},{"title":"Nei","payload":"ask for mother",link:15}]},

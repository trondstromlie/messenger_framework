...
async function generic_template(sender_psid, user, message, custom_field_obj, quick_reply_obj, in_message , bool_obj, jump_to ,err_message, pause , generic_template_obj , webview_obj) {
  ...
  // else if button template 
    ...
    let buttons = [
      {type:"web_url",url:"https://www.trondstromlie.com", title:" les mer om meg her "},
      {type:"web_url",url:"https://phonestats.herokuapp.com/webview?message=hello&sender_psid=3486132838081978&field_name=new_field", title:"Open a web view", "webview_height_ratio": "COMPACT","messenger_extentions":"true"},
      {type:"postback", title:"Bestill Pizza!", payload:'{"messenger_process":"Pizza"}' }
    ];

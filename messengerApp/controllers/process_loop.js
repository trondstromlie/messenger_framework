  ...
  const user_process = {processes: [
    {
     ...
     steps: [
         ...
         {name:"confirm mor",func:process_functions.send_quick_reply,msg:"velg Ja eller Nei",quick_reply_obj:[{"content_type":"text","title":"Ja","payload":"send to bio",link:15},{"content_type":"text","title":"Nei","payload":"ask for mother",link:10}]},

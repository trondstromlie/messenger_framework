  ...
  const user_process = {processes: [
    {
     ...
     steps: [
         ...
         {name:"listen_for_mor",func:process_functions.listen_for_data,custom_field_name:"mor",msg:" venter på custom field mor >> ",err_message:{msg:"Dette er var ikke dataen jeg forventet ", link:9} },
         ...
         {name:"confirm mor",func:process_functions.send_quick_reply,msg:"velg Ja eller Nei",quick_reply_obj:[{"content_type":"text","title":"Ja","payload":"send to bio",link:16},{"content_type":"text","title":"Nei","payload":"ask for mother",link:10}]},
         {name:"listen_for_mor",func:process_functions.listen_for_quick_reply,custom_field_name:"mor", msg:"Skriv ja eller nei " , quick_reply_obj:[{"content_type":"text","title":"Ja","payload":"send to bio",link:16},{"content_type":"text","title":"Nei","payload":"ask for mother",link:10}]},
         {name:"get_bio",func:process_functions.send_empty_message, msg:" Takk :) nå må du skrive litt om deg selv " , field_name:"bio"},
         {name:"listen_for_bio",func:process_functions.ask_for_custom_data,msg:"hva er din bio, skriv det her"},
         ...
         {name:"confirm bio",func:process_functions.send_quick_reply,quick_reply_obj:[{"content_type":"text","title":"Ja","payload":"send to bio",link:21},{"content_type":"text","title":"Nei","payload":"ask for bio",link:16}]},
         {name:"listen_for_bio",func:process_functions.listen_for_quick_reply,custom_field_name:"mor", "":"Skriv ja eller nei >> " , quick_reply_obj:[{"content_type":"text","title":"Ja","payload":"send to bio",link:21},{"content_type":"text","title":"Nei","payload":"ask for mother",link:16}]},
